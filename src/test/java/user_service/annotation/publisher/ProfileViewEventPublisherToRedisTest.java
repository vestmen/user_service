package user_service.annotation.publisher;
...
import user_service.aspect.redis.ProfileViewEventPublisherToRedis;
import user_service.config.context.UserContext;
import user_service.dto.user.ProfileViewEventDto;
...
import static user_service.util.users.UserTestUtil.buildUser;
import static user_service.util.users.UserTestUtil.buildUsers;
