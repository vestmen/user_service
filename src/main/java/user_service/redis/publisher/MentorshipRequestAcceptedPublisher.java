package user_service.redis.publisher;
...
import user_service.dto.mentorship_request.MentorshipRequestAcceptedDto;
...
public class MentorshipRequestAcceptedPublisher extends AbstractEventPublisher<MentorshipRequestAcceptedDto> {
    ...
    @AfterReturning(
            pointcut = "@annotation(user_service.annotation.event.SendMentorshipRequestAcceptedEvent)",
